...
public class DessertDataSave extends AppCompatActivity {

    EditText data_name, data_description, data_price;
    Button save_detail, back;
    DessertData DBDessert;
    String name, description, price;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_dessert_data_save);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(DessertDataSave.this, AdminDesserts.class);
                startActivity(i);
            }
        });
        ...
        save_detail.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                else
                {
                    ...
                    Intent intent = new Intent(DessertDataSave.this, AdminDesserts.class);
