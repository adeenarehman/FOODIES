...
public class FastFoodDataSave extends AppCompatActivity {

    EditText data_name, data_description, data_price;
    Button save_detail, back;
    FastFoodData DBFastFood;
    String name, description, price;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_fast_food_data_save);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(FastFoodDataSave.this, AdminFastFood.class);
                startActivity(i);
            }
        });
        ...
        save_detail.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DBFastFood = new FastFoodData(FastFoodDataSave.this);

                name= data_name.getText().toString();
                description = data_description.getText().toString();
                price = data_price.getText().toString();

                long fastfood_id = DBFastFood.insertData(name,description, price);
                ...
                else
                {
                    ...
                    Intent intent = new Intent(FastFoodDataSave.this, AdminFastFood.class);
